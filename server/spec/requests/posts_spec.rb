...
RSpec.describe "Posts", type: :request do
  ...
  describe 'POST /posts' do
    # valid payload
    let(:valid_attributes) { { poster: 'Franklin Bristow', description: 'post' } }

    context 'when the request is valid' do
      before { post '/posts', params: valid_attributes }

      it 'creates a post' do
        expect(json['poster']).to eq('Franklin Bristow')
      end
    ...
    context 'when the request is invalid' do
      before { post '/posts', params: { poster: 'Foobar' } }
  ...
  describe 'PUT /posts/:id' do
    let(:valid_attributes) { { poster: 'NotABot' } }
